...
const Footer = () => {
  ...
  return (
    <div  className='w-full bg-[#DD2B1C]  text-white sm:h-[85vh] md:h-[100vh] lg:h-[95vh] h-[50vh] p-[4vw] sm:p-[4vw] md:p-[4vw] lg:p-[4vw] sm:pb-[8vw] md:pb-[4vw] lg:pb-[4vw] px-[2.5vw]'>
