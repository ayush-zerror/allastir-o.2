                        ...
                        {timelineData.map((data, index) => (
                            ...
                            >
                                <Image
                                    ...
                                    alt={`Image ${index + 1}`}
                                />
                                <div style={{ background: "linear-gradient(to bottom , transparent , black)" }} className='sm:hidden w-full h-full absolute top-0 left-0 flex flex-col justify-end p-[2vw]'>
                                    <div className='sm:h-[8.5vw] md:h-[6vw] lg:h-[6vw] xl:h-[4vw] h-[4vw] w-fit overflow-hidden sm:mb-[3vw] md:mb-[3vw] lg:mb-[3vw] xl:mb-[3vw]'>
                                        {
                                            timelineData.map((data, i) => (
