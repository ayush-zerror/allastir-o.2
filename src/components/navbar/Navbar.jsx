...
const Navbar = ({ navRef }) => {
  ...
  return (
    <div ref={navRef} className='w-full sm:px-[4vw] md:px-[4vw] lg:px-[4vw] px-[2.5vw] sm:py-[3.1vw] md:py-[3.1vw] lg:py-[3.1vw] py-[.8vw] text-black bg-white flex items-center justify-between fixed z-[99] top-0 left-0' style={{ backdropFilter: "blur(40px)" }}>
