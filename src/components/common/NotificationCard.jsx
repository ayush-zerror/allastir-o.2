...
const NotificationCard = ({
  ...
  return (
    <div
      onClick={onView}
      className="notification cursor-pointer w-full overflow-hidden relative pointer-events-auto bg-[#DD2B1C] rounded-xl flex items-center justify-between sm:gap-[3vw] gap-[1vw] sm:p-[4vw]"
    >
      <Image
      ...
      <div className="popup_text sm:w-full  w-[170px] text-white flex flex-col sm:text-[3vw] text-[.7vw] relative">
        ...
        <button
          onClick={onView}
          className="w-fit mt-[.7vw] py-[.3vw] px-[.9vw] sm:py-[1.5vw] sm:px-[4vw] bg-white text-[#DD2B1C] font-semibold rounded-full"
        >
          View Details +
        </button>
      </div>
      <Image
        className="h-[170px] sm:hidden block w-[230px] object-cover"
        width={1000}
        height={1000}
        src={imageRight}
        alt="event right"
